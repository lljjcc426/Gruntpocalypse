...
var hljs = function() {
  ...
  const J = t,
    ...
    ne = t => {
        ...
        function c() {
          ...
          for (; n;) {
            ...
            if (r) {
              const [e, a] = r
              ;
              if (A.addText(t), t = "", l[i] = (l[i] || 0) + 1, l[i] <= 7 && (C += a), e.startsWith("_")) t += n[0];
              else {
      ...
      "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", (() => {
        ...
        s = !0
      }, t.versionString = "11.10.0", t.regex = {
        concat: b,
        lookahead: d,
        either: m,
        optional: u,
  ...
  var Pe = Object.freeze({
    ...
    grmr_perl: e => {
      ...
      return i.contains = b, r.contains = b, {
        name: "Perl",
        aliases: ["pl", "pm"],
        keywords: a,
        contains: b
